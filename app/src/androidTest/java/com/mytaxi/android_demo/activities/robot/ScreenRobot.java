...
public abstract class ScreenRobot<T extends ScreenRobot> {
    ...
    public T checkIsDisplayed(int viewId) {
        onView(withId(viewId)).check(matches(isDisplayed()));
        return (T) this;
    }

    public T checkIsClickable(int... viewIds) {
    ...
    public T clickOnView(int viewId) {
    ...
    public T printLog(String result) {
        System.out.println(result);
        return (T) this;
    }


    public T checkViewHasHint(int viewId, String text) {
        onView(withId(viewId)).check(matches(isDisplayed()));
        return (T) this;
    }
